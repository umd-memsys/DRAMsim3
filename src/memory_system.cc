...
void MemorySystem::PrintStats(int tag) const { dram_system_->PrintStats(tag); }

void MemorySystem::PrintEpochStats(int tag) const { dram_system_->PrintEpochStats(tag); }
